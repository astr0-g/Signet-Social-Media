...
async function main() {
    ...
    contract.on("Unlike", (messageSender, signetId, signetoraddress, time) => {
        console.log(messageSender, signetId, signetoraddress, time)
        var formdata = new FormData()
        formdata.append("typeOfNotification", "unlike")
        ...
        formdata1.append("liked", "-1")
        formdata1.append("stared", "0")
        formdata1.append("views", "0")
